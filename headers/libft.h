 ...
 * @return This function does not return; it wri
 * tes directly to the file descriptor.
 */
 ...
 * @param s The string to be written.
 * @param fd The file descriptor w
 * here the string and newline will be written.
 * @return This function does not return; it writes dir
 * ectly to the file descriptor.
 */
 ...
 *  if applicable, or the original character if not.
 */
 ...
 * @return This function does not return; it modifi
 * es each element through the provided function.
 */
void			ft_lstiter(t_list *lst, void (*f)(void *));
/**
 * @brief Applies a function to each element of t
 * he list and creates a new list with the results.
 ...
 * @return A pointer to the reallocated memory bloc
 * k, or NULL if the reallocation fails.
 */
void			*ft_realloc(void *ptr, size_t old_size, size_t new_size);

/**
 * @brief Reallocates memory, resizing it to
 * the new size and sets to 0 all elements.
 * @param ptr A pointer to the existing memory block to be resized.
 * @param old_size The current size of the memory block.
 * @param new_size The new size of the memory block.
 * @return A pointer to the reallocated memory
 *  block, or NULL if the reallocation fails.
 */
 ...
 * @return A pointer to the first occurren
 * ce of the character, or NULL if not found.
 */
 ...
 * @return An integer less th
 * an, equal to, or greater than zero, d
 * epending on whether the first memory area is
 *  less than, equal to, or greater than the second memory area.
 */
 ...
 * (the substrings), or NULL if the allocation fails.
 */
...
/**
	...
	* n array of strings but doesnt free the mtx itself since stack allocated.
    * @param mtx A pointer to the array of strings to be freed.
    * @return This function does not return;
	* it frees the memory used by the array.
 */
...
/**
 * @brief Concatenates two strings into a newly all
 * ocated string, stopping at the first newline character.
 * @param s1 The first string.
 * @param s2 The second string.
 * @return A pointer to the newly allocated concate
 * nated string, or NULL if the allocation fails.
 */
char			*ft_strjoin_until_nl(const char *s1, const char *s2);
/**
 * @brief Concatenates two strings into a newl
 * y allocated string, then frees the 1st string.
 * @param s1 The first string.
 * @param s2 The second string.
 * @return A pointer to the
 * newly allocated concatenated string, or NULL if the allocation fails.
 */
char			*ft_freejoin(char *s1, const char *s2);
/**
 * @brief Trims a string by removing
 *  characters from the start and end based on a set of characters.
 * @param s1 The string to be trimmed.
 * @param set The set of characters to be removed.
 * @return A pointer to the newly
 *  allocated trimmed string, or NULL if the allocation fails.
 */
 ...
 * @return A pointer to the newly allocated string
 *  representation of the integer, or NULL if the allocation fails.
 */
char			*ft_itoa(int n);
...
/**
 * @brief Copies up to dstsize - 1 characters
 ...
 * @return An integer less than, equal
 * to, or greater than zero, depending on whether th
 * e first string is less than, equal to, or greater than the second string.
 */
int				ft_strcmp(const char *str, const char *cmp);
/**
 * @brief Appends up to dstsize - strlen
 * (dst) - 1 characters from the source string to the destination string.
 * @param dst The destination buffer.
 ...
 * @return A pointer to the first occurr
 * ence of the character, or NULL if not found.
 */
 ...
 * @param s The string to be searched.
 * @param c The character to search for.
 * @return A pointer to the last occ
 * urrence of the character, or NULL if not found.
 */
 ...
 * @param cmp The second string to compare.
 * @param n_bytes The number of bytes to compare.
 * @return An integer less tha
 * n, equal to, or gr
 * seater than zero, depending on whether the
...
/**
 * @brief Applies a function to each
 *  character of a string to create a new string.
 * @param s The string to be mapped.
 * @param f The function to apply to each character.
 * @return A pointer to the newly allocated str
 * ing resulting from applying the function, or NULL if the allocation fails.
 */
 ...
 * @return This function does not return; it modi
 * fies each character through the provided function.
 */
 ...
 * @return an unsigned int  to the first
